...
import { CustomerCarrierContactForm } from 'Integration-E2E/spec/manage-customer-carrier-contacts-v2.spec';
...
export class ManageCustomerCarrierContactsPage {
  ...
  readonly readOnlyFields: Locator;
  ...
  constructor(page: Page) {
    ...
    this.viewModeButton = this.page.locator('.view-mode');
    this.readOnlyFields = this.page.locator('.read-only-field');
  }

  public async manageCarrierContact(formData: CustomerCarrierContactForm) {
    await this.page.locator('#ag-37-input').check();

...
export class ERPaidLifeAndAddPlanTemplatePage {
  readonly page: Page;
  ...
  readonly addMinBnftAmtField: Locator;
  readonly addMaxBnftAmtField: Locator;
  readonly radioButton: Locator;
  readonly fixedAmtOption: Locator;
  ...
  constructor(page: Page) {
    ...
    this.planAmtStyle = page.getByText('Plan Amount Style');
    ...
    this.addMinBnftAmtField = page.getByLabel('ADD Min Benefit Amount');
    this.addMaxBnftAmtField = page.getByLabel('ADD Max Benefit Amount');
    this.radioButton = page.getByLabel('No', { exact: true });
    this.fixedAmtOption = page.getByRole('option', { name: 'Fixed Amounts' });
  ...
  async documentAndValidateLifeAndADDTemplate() {
    ...
    await this.utilities.executeStep(
      this.addMinBnftAmtField,
      'fill',
      'enter value 20 into add min benefit amount field',
      '20'
    );
    await this.utilities.executeStep(
      this.addMaxBnftAmtField,
      'fill',
      'enter value 99 into add max benefit amount field',
      '99'
    );
    await this.utilities.executeStep(
      this.planAmtStyle,
    ...
    await this.utilities.executeStep(this.fixedAmtOption, 'click', 'select option fixed amounts');
    await this.utilities.executeStep(
      this.lifeMaxBnftAmtField,
      'fill',
      'enter value 99 into life max benefit amount field',
